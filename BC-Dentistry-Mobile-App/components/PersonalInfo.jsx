  ...
  return (
    <View className="flex flex-col gap-2">
      ...
      <View className="mb-4 p-2 gap-5">
        ...
        <Field fieldTitle="Emirates ID" fieldText={user?.emiratesID ?? user?.blockchainID ?? 'Not provided'} />
        <Field fieldTitle="Email" fieldText={user?.email ?? 'Not provided'} />
        <Field fieldTitle="Mobile Phone" fieldText={user?.contactNumber ?? user?.phone ?? 'Not provided'} />
