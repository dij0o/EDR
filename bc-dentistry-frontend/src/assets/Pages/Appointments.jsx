    ...
    return (
        <div id="Appointments" className="w-full flex flex-col mb-24">
            {isPatient
                ...
                : <AppointmentsBar appointments={appointments} loading={appointmentsLoading} onCreated={() => setRefreshKey((value) => value + 1)} />}
            <AppointmentsSection refreshKey={refreshKey} onDataLoaded={setAppointments} onLoadingChange={setAppointmentsLoading} />
