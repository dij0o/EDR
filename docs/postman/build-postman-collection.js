  ...
  },
  {
    ...
    item: [
      ...
      request('Complete Referral', 'POST', db, '/referrals/{{requestId}}/complete',
        ...
        { body: { completionSummary: 'Specialist treatment completed; follow-up returned to the referring care team.' } }),
  ...
  },
  {
    ...
    item: [
      ...
      request('Grant Consent', 'POST', db, '/grantConsent',
        '**Purpose:** Let the patient approve a clinic-admin-approved referral so the receiving doctor can access the specified record categories for the recorded purpose and validity period.\n\n**Effect:** Changes the referral to `ACTIVE`, writes the decision to Fabric, and can trigger a notification. This does not transfer the patient.\n\n**Identity rule:** `patientID` must match the patient blockchain ID in the JWT.',
