...
- Phase 9 deployment result - 2026-07-15: migration, admin create/update/cancel, persisted web flow, and patient upcoming/past mobile source flow are deployed. VM checkout aligned to `f3f8526` after backup `/home/ubuntu/deployment-backups/20260715-085512-phase9-predeploy`; backend/API 33/33, frontend 8/8, lint/build, migration/API/Nginx checks, and `PHASE9_APPOINTMENT_SMOKE_OK` passed. No Fabric upgrade was required. Legacy null-clinic doctors require existing patient assignment; packaged mobile evidence remains pending.
...
- Appointment management is deployed for admin web/API and patient mobile source/API; packaged mobile evidence remains.
...
8. Appointment management. **Deployed and smoke-verified on AWS 2026-07-15; migration applied; checkout `f3f8526`.**
