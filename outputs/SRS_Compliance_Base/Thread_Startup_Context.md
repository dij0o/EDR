...
- Phase 5 AWS readiness gate - 2026-07-12: SSH access and running Database API/MySQL services were confirmed. Deployment is paused because live legacy `Doctor1` and `Doctor2` rows contain no authoritative license numbers or Emirates IDs. Obtain those four regulated values before applying the migration; do not invent them.
